...
def page_index(lang, C):
    ...
    services = "".join(
      ...
      <div class="card__media"><img src="{a}img/{s['img']}" alt="{e(s['alt'])}" loading="lazy" decoding="async"></div>
...
<section class="hero">
  <div class="hero__media">
    <img src="{a}img/hero.svg" alt="{e(H['hero_alt'])}" fetchpriority="high" decoding="async">
  </div>
...
<section class="section section--white">
  <div class="wrap split">
    ...
    <div class="media-frame reveal" data-delay="1">
      <img src="{a}img/home-service.svg" alt="{e(H['home_service']['img_alt'])}" loading="lazy" decoding="async">
    </div>
  </div>
</section>
...
def page_services(lang, C):
  ...
  <div class="wrap split{rev}">
    ...
    <div class="media-frame reveal" data-delay="1">
      <img src="{a}img/{it['img']}" alt="{e(it['alt'])}" loading="lazy" decoding="async">
    </div>
  </div>
</section>""")
...
def page_results(lang, C):
    ...
    tiles = "".join(
      ...
      <div class="card__media"><img src="{a}img/{g['img']}" alt="{e(g['alt'])}" loading="lazy" decoding="async"></div>
...
<section class="section section--white">
  <div class="wrap split">
    <div class="media-frame reveal">
      <img src="{a}img/portrait.svg" alt="{e(A['img_alt'])}" loading="lazy" decoding="async">
    </div>
...
<section class="section">
  <div class="wrap split">
    ...
    <div class="media-frame reveal" data-delay="1">
      <img src="{a}img/studio.svg" alt="{e(A['standards_img_alt'])}" loading="lazy" decoding="async">
    </div>
  </div>
</section>
